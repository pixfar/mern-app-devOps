...
const Footer = () => {
  return (
    <footer className="container mx-auto">
      {/* <!-- Footer Bottom --> */}
      <div className=" px-4 flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:gap-0">
        <motion.div
          variants={{
            hidden: {
              opacity: 0,
        ...
        >
          <ul className="flex items-center gap-2 lg:gap-8">
            ...
            <li className="hover:text-secondary dark:text-white">
              <Link className="" href={"/Impressum"} title="pakete-preise">
                {/* Plans */}
                Impressum
              </Link>
            </li>
        ...
        >
          <p>
            &copy; {new Date().getFullYear()} MEIN JUSTUS. All rights reserved
          </p>
        </motion.div> */}
          ...
          <ul className="flex items-center  gap-5">
            <li>
              <a href="#" aria-label="social icon">
                <svg
                  className="fill-[#28568b] dark:fill-white transition-all duration-300 hover:fill-primary"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                  fill="none"
